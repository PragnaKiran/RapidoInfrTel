      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-14">
        ...
        <div className="space-y-6">
          <div className="border-b border-slate-800 pb-4">
            <span className="text-xs font-bold uppercase tracking-wider text-fiber-400">Equity in Technology</span>
        ...
        <div className="glass-card p-8 rounded-2xl border border-amber-500/30 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            ...
            <Link
              href="/contact"
              className="px-5 py-3 rounded-xl text-xs font-bold text-telecom-950 bg-amber-400 hover:bg-amber-300 shadow-lg shadow-amber-500/20 transition-all flex items-center gap-2"
            >
